...
- Implementation code, identifiers, commit messages, and file content follow existing
  conventions; this rule governs proposal/communication prose to the user.
...
- Enforcement: 제안 프로즈는 advisory; 커밋 메시지 한글은 hard(commit-msg 훅); 출력 문구 한글은 리뷰 어드바이저리(Rule 9).
